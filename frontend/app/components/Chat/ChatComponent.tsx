        ...
        <div className="flex sm:flex-col md:flex-row justify-between items-start md:gap-3 ">
            ...
            <div className='flex lg:flex-row sm:flex-col justify-between items-start sm:w-full md:w-1/2 lg:w-4/6 gap-3'>
                ...
                <div className='sm:w-full lg:w-3/4 flex flex-col gap-2'>
                    <InfoComponent settingConfig={settingConfig} tooltip_text={document_interface_info} display_text='Document Viewer' />
                    <DocumentComponent production={production} setSelectedChunk={setSelectedChunk} selectedChunk={selectedChunk} APIhost={APIHost} settingConfig={settingConfig} deletable={false} selectedDocument={null} />
                </div>
            </div>
