...
interface ChatInterfaceComponentOldProps {
...
const ChatInterfaceComponentOld: React.FC<ChatInterfaceComponentOldProps> = ({
  APIHost,
  settingConfig,
  setChunks,
  setChunkTime,
...
export default ChatInterfaceComponentOld;
