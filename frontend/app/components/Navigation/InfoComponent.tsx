...
const InfoComponent: React.FC<InfoComponentProps> = ({ tooltip_text, display_text, settingConfig }) => {

    return (
        <div className={`items-center gap-2 ${settingConfig.Chat.settings.info_button.checked ? ("flex") : ("hidden")}`}>
