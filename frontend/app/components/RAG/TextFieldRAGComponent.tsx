...
const TextFieldRAGComponent: React.FC<TextFieldComponentProps> = ({ title, TextFieldSetting, RAGConfig, RAGConfigTitle, RAGComponentTitle, setRAGConfig }) => {
    ...
    const handleChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        setRAGConfig((prevConfig: any) => {
            ...
            newConfig[RAGConfigTitle].components[RAGComponentTitle].config[title].text = newText
            return newConfig;
        });
            ...
            <div className='flex items-center justify-center'>
                <label className="input input-bordered flex items-center gap-2 w-full lg:text-base text-sm bg-bg-verba">
                    <input
                        ...
                        className="grow"
                        placeholder={title}
                        value={(RAGConfig[RAGConfigTitle].components[RAGComponentTitle].config as any)[title].text}
