    ...
    return (
        <div className="flex sm:flex-col md:flex-row justify-center items-start gap-3 ">
            ...
            <div className='sm:w-full md:w-2/4'>
                <DocumentSearchComponent APIHost={APIHost} setSelectedDocument={setSelectedDocument} settingConfig={settingConfig} selectedDocument={selectedDocument} />
            </div>

            <div className='sm:w-full md:w-2/4'>
                <DocumentComponent deletable={true} selectedChunk={selectedDocument} APIhost={APIHost} settingConfig={settingConfig} selectedDocument={null} />
            </div>
