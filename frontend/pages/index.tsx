    ...
    return (
        <main className="flex min-h-screen flex-col items-center justify-between p-10 text-gray-900">
            ...
            <div className="flex flex-col w-full items-start">
                ...
                <div
                    className={`lg:flex md:flex ${documentChunks.length <= 8 ? 'full:justify-center' : ''} justify-items-start overflow-x-auto h-36 w-full mb-2 hidden`}>
                    {documentChunks.map((chunk, index) => (
                        ...
                        >
                            ...
                            >
                                <div
                                    className={`text-xs mb-1 ${focusedDocument === chunk ? '' : 'fade-in-out'} bg-yellow-300 p-2 rounded-lg w-full`}>
                                    {chunk.doc_type}
                                </div>
                                <div className="flex space-x-2 mt-1">
                                    <div
                                        className={`flex items-center rounded-md bg-gray-200 p-2 truncate h-16 border-2 shadow-md hover:border-white border-black ${focusedDocument === chunk ? "bg-green-300" : "bg-gray-300"}`}>
                ...
                <div className="flex w-full space-x-4 overflow-y-auto mb-20">
                    <div
                        className="lg:w-1/2 md:w-full sm:w-full p-2 border-2 shadow-lg border-gray-900 rounded-xl animate-pop-in">
                    ...
                    Powered by Weaviate ❤️
                        ...
                        >
                            <input
                                ...
                                disabled={isFetching}
                                placeholder="What is the most profitable Apple product in 2022?"
