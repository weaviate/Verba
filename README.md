...
- CLEAR WEAVIATE EMBEDDED (rm ~/.local/share/weaviate)
- Docker IMAGE (4GB, with Ollama)
- Docker with .env `docker compose --env-file goldenverba/.env up -d`
- Docker also usable when u have ollama server installed
- verba start --port --host
